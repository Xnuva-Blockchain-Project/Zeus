 ...
 * between zeusd, and zeus-qt and non-server tools.
*/
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/Xnuva-Blockchain-Project/Zeus>";
    ...
    return FormatParagraph(strprintf("Copyright (C) %i-%i The Bitcoin Core Developers", 2009, COPYRIGHT_YEAR)) + "\n" +
           ...
           "\n" +
           FormatParagraph(strprintf(_("Please contribute if you find Zeus useful. "
