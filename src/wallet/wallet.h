...
public:
    ...
    /* Staking */
    bool CreateCoinStake(const CKeyStore& keystore, unsigned int nBits, int64_t nSearchInterval, const uint256& hashPrevBlock, CAmount& nFees, CMutableTransaction& tx, CKey& key);
