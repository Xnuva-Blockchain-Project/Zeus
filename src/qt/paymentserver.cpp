...
const QString BITCOIN_IPC_PREFIX("zeus:");
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/zeus-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/zeus-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/zeus-paymentrequest";
    ...
    optionsModel(0)
{
    ...
    // on Mac: sent when you click zeus: links
...
//
// OSX-specific way of handling zeus: URIs and PaymentRequest mime types.
...
void PaymentServer::initNetManager()
{
    ...
    // netManager is used to fetch paymentrequests given in zeus: URIs
